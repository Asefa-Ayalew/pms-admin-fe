...
import { useArchiveTestimonialMutation } from "../_store/testimonial.query";
...
export default function ReasonForm(props: Props) {
  const [archiveTestimonial, { isLoading: archivingTestimonial }] =
  ...
  const onSubmit: SubmitHandler<FormSchema> = async (data) => {
    try {
      const response = await archiveTestimonial({
        ...data,
        remark: data.reason || "",
