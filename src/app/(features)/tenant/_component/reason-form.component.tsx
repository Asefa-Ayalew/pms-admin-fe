...
import z from "zod";
import { useArchiveTenantMutation } from "../_store/tenant.query";
...
export default function ReasonForm(props: Props) {
  const [archiveTenant, { isLoading: archivingTenant }] =
  ...
  const onSubmit: SubmitHandler<FormSchema> = async (data) => {
    try {
      const response = await archiveTenant({
        ...data,
        remark: data.reason || "",
